...
save "C:\Users\obine\Music\Documents\Project_26\dofile\original\pp_only\wave_five\apppend_agchild15.dta", replace





use "C:\Users\obine\Music\Documents\Project_26\dofile\original\pp_only\wave_five\apppend_agchild15.dta", clear
...
merge 1:m hhid  using "C:\Users\obine\Music\Documents\Project_26\dofile\original\pp_only\wave_five\apppend_agchild15.dta", gen(fil)
...
tabstat haz haz2 peraeq_cons_protein value_harvest shock shortfall_Mar mrk_dist_w real_maize_price_mr good fair total_qty real_hhvalue field_size hh_members hh_headage femhead attend_sch  mean_annual_rainfall  dev_rain_Mar dev_rain_Aug  [w=weight], statistics( mean median sd min max ) columns(statistics)

misstable summarize haz peraeq_cons_protein peraeq_cons_cereal totalcons_protein totalcons_cereal shock value_harvest quant_harv_kg ha_planted real_tpricefert_cens_mrk  shortfall_Mar mrk_dist_w real_maize_price_mr good fair total_qty real_hhvalue field_size hh_members hh_headage femhead attend_sch  mean_annual_rainfall  dev_rain_Mar dev_rain_Aug zone state lga ea
...
*gen hhp = haz +0.8 if year ==2015
*replace haz = hhp if  year ==2015
...
twoway ///
    ...
    xlabel(2010 2012 2015, labsize(medlarge)) ///
...
save "C:\Users\obine\Music\Documents\Project_26\dofile\original\pp_only\akuffo_plot\agchild15.dta", replace ///everything
...
*ivreg2
*******************************************************
use "C:\Users\obine\Music\Documents\Project_26\dofile\original\pp_only\akuffo_plot\agchild15.dta", clear //everything
...
ivregress 2sls lperaeq_cons_protein ///
    ...
    ag_shock mrk_dist_w real_maize_price_mr   real_hhvalue ///
    field_size hh_members hh_headage femhead attend_sch  mean_annual_rainfall ///
	TAvg_mrk_dist_w TAvg_value_harvest TAvg_real_maize_price_mr  TAvg_real_hhvalue ///
...
ivreghdfe lperaeq_cons_protein ///
    ...
    field_size hh_members hh_headage femhead attend_sch  mean_annual_rainfall ///
	TAvg_mrk_dist_w TAvg_value_harvest TAvg_real_maize_price_mr TAvg_real_hhvalue ///
    TAvg_field_size TAvg_hh_members TAvg_hh_headage TAvg_femhead TAvg_attend_sch TAvg_shock TAvg_mean_annual_rainfall ///
    , absorb(hhid year) cluster(hhid)
eststo model1
esttab m* using "C:\Users\obine\Music\Documents\Project_26\result\protein.regression.rtf", label replace cells(b(star fmt(%9.2f)) se(par fmt(%9.2f)))
...
ivregress 2sls lperaeq_cons_protein ///
    ...
    shock mrk_dist_w real_maize_price_mr   real_hhvalue ///
    field_size hh_members hh_headage femhead attend_sch  mean_annual_rainfall ///
	TAvg_mrk_dist_w TAvg_value_harvest TAvg_shock TAvg_real_maize_price_mr  TAvg_real_hhvalue ///
    TAvg_field_size TAvg_hh_members TAvg_hh_headage TAvg_femhead TAvg_attend_sch  TAvg_mean_annual_rainfall ///
    i.year, vce(cluster hhid)
eststo model1
esttab m* using "C:\Users\obine\Music\Documents\Project_26\result\protein.regression.rtf", label replace cells(b(star fmt(%9.2f)) se(par fmt(%9.2f)))
...
eststo clear
ivregress 2sls haz ///
    (high_income inc_shock = dev_rain_Mar zMar_shock  zAug_shock) ///
    ag_shock mrk_dist_w real_maize_price_mr real_hhvalue ///
    field_size hh_members hh_headage femhead attend_sch  mean_annual_rainfall ///
...
reg lperaeq_cons_protein dev_rain_Mar dev_rain_Aug shock mrk_dist_w real_maize_price_mr real_hhvalue ///
    field_size hh_members hh_headage femhead attend_sch  mean_annual_rainfall ///
...
 TAvg_high_income determines significance as well
...
ivreghdfe haz ///
    (high_income inc_shock = TAvg_high_income dev_rain_Aug zMar_shock zAug_shock) ///
    shock mrk_dist_w real_maize_price_mr  real_hhvalue ///
    field_size hh_members hh_headage femhead attend_sch  mean_annual_rainfall ///
	TAvg_mrk_dist_w  TAvg_shock TAvg_real_maize_price_mr  TAvg_real_hhvalue ///
    TAvg_field_size TAvg_hh_members TAvg_hh_headage TAvg_femhead TAvg_attend_sch  TAvg_mean_annual_rainfall ///
    , absorb( year) cluster(hhid)
